...
public class Logger {
    ...
    /**
     * Send a VERBOSE log message and log the com.robot.baselibs.exception.
     *
     * @param msg The message you would like logged.
     * @param thr An com.robot.baselibs.exception to log
     */
    ...
    /**
     * Send a DEBUG log message and log the com.robot.baselibs.exception.
     *
     * @param msg The message you would like logged.
     * @param thr An com.robot.baselibs.exception to log
     */
    ...
    /**
     * Send a INFO log message and log the com.robot.baselibs.exception.
     *
     * @param msg The message you would like logged.
     * @param thr An com.robot.baselibs.exception to log
     */
    ...
    /**
     * Send a WARN log message and log the com.robot.baselibs.exception.
     *
     * @param msg The message you would like logged.
     * @param thr An com.robot.baselibs.exception to log
     */
    ...
    /**
     * Send an empty WARN log message and log the com.robot.baselibs.exception.
     *
     * @param thr An com.robot.baselibs.exception to log
     */
    ...
    /**
     * Send an ERROR log message and log the com.robot.baselibs.exception.
     *
     * @param msg The message you would like logged.
     * @param thr An com.robot.baselibs.exception to log
     */
