package com.robot.baselibs.view.swipetoloadlayout;
...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    /**
     * auditStatus of SwipeToLoadLayout
     */
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * Scrolling duration auditStatus release to refresh -> refreshing
     */
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * Scrolling duration auditStatus refresh complete -> default
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * Scrolling duration auditStatus default -> refreshing, mainly for auto refresh
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * Scrolling duration auditStatus release to loading more -> loading more
     */
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * Scrolling duration auditStatus load more complete -> default
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * Scrolling duration auditStatus default -> loading more, mainly for auto load more
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                // swipeToRefresh -> finger up -> finger down if the auditStatus is still swipeToRefresh
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                // if it isn't an ing auditStatus or default auditStatus
    ...
    /**
     * is current auditStatus refreshing
     *
     * @return
     */
    ...
    /**
     * is current auditStatus loading more
     *
     * @return
     */
    ...
    private void fingerScroll(final float yDiff) {
        ...
        // make sure (targetOffset>0 -> targetOffset=0 -> default auditStatus)
        // or (targetOffset<0 -> targetOffset=0 -> default auditStatus)
        // forbidden fling (targetOffset>0 -> targetOffset=0 ->targetOffset<0 -> default auditStatus)
        // or (targetOffset<0 -> targetOffset=0 ->targetOffset>0 -> default auditStatus)
        // I am so smart :)
    ...
    /**
     * Set the current auditStatus for better control
     *
     * @param status
     */
