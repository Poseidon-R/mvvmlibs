...
public class ChoiceAddressDialog extends Dialog implements OnWheelChangedListener, View.OnClickListener {
    ...
    public void setDefault(final String defaultProvice, final String defaultCity, final String defaultArea){
        parseProvinceDatas(defaultProvice,defaultCity,defaultArea);
    }
...
//        }
         ...
         * 没有则默认第一个
         */
        Logger.e(defProIndex+"----"+defCityIndex+"----"+defDistIndex);
